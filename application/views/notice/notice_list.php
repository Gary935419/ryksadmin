                ...
                <div class="layui-card-body ">
                    <form class="layui-form layui-col-space5" method="get" action="<?= RUN, '/notice/notice_list' ?>">
                        <div class="layui-inline layui-show-xs-block">
                            <input type="text" name="ncontent" id="ncontent" value="<?php echo $ncontent ?>"
                                   placeholder="公告内容" autocomplete="off" class="layui-input">
                        </div>
                        <div class="layui-inline layui-show-xs-block">
                                ...
                                <tr id="p<?= $once['nid'] ?>" sid="<?= $once['nid'] ?>">
                                    ...
                                    <td class="td-manage">
                                        <button class="layui-btn layui-btn-normal"
                                                onclick="xadmin.open('编辑','<?= RUN . '/notice/notice_edit?nid=' ?>'+<?= $once['nid'] ?>,900,250)">
                                            <i class="layui-icon">&#xe642;</i>编辑
                                        </button>
                                        <button class="layui-btn layui-btn-danger"
                                                onclick="notice_delete('<?= $once['nid'] ?>')"><i class="layui-icon">&#xe640;</i>删除
                                        </button>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
