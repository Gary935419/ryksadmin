        ...
        <form method="post" class="layui-form" action="" name="basic_validate" id="tab">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline" style="width: 300px;">
                    ...
                    <div class="layui-upload-list">
                        <input type="hidden" name="taimg" id="taimg" lay-verify="taimg" autocomplete="off"
                               class="layui-input">
                        <img class="layui-upload-img" style="width: 100px;height: 100px;display: none;" id="taimgimg" name="taimgimg">
                        <p id="demoText"></p>
                    </div>
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline" style="width: 500px;">
                    <input type="radio" name="if_recommend" lay-skin="if_recommend" title="推荐"
                           value="1" checked>
                    <input type="radio" name="if_recommend" lay-skin="primary" title="不推荐"
                           value="2">
                </div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline" style="width: 610px;">
                    <textarea id="requirement" name="requirement" placeholder="请输入内容" lay-verify="requirement" class="layui-textarea"></textarea>
                </div>
            </div>
            <div class="layui-form-item">
                <label for="L_pass" class="layui-form-label" style="width: 30%;">
                ...
                <div class="layui-input-inline" style="width: 610px;">
                    <textarea id="tatips" name="tatips" placeholder="请输入内容" lay-verify="tatips" class="layui-textarea"></textarea>
                </div>
            </div>
            <div class="layui-form-item">
                <label for="L_pass" class="layui-form-label" style="width: 30%;">
                ...
                <div class="layui-input-inline" style="width: 610px;">
                    <textarea id="tacontents" name="tacontents" placeholder="请输入内容" lay-verify="tacontents" class="layui-textarea"></textarea>
                </div>
            </div>
            <div class="layui-form-item">
        ...
        var uploadInst = upload.render({
            ...
            ,before: function(obj){
                ...
                obj.preview(function(index, file, result){
                    ...
                    var img = document.getElementById("taimgimg");
