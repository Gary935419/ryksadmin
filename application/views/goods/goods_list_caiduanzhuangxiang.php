        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-body ">
                    <form class="layui-form layui-col-space5" method="get" action="<?= RUN, '/goods/goods_list_caiduanzhuangxiang' ?>">
...
<!--									<td>--><?//= date('Y-m-d', $once['jiaohuoqi']) ?><!--</td>-->
                                    ...
                                    <td class="td-manage">
                                        <button class="layui-btn layui-btn-normal"
                                                onclick="xadmin.open('查看','<?= RUN . '/goods/goods_list1_caiduanzhuangxiang?id=' ?>'+'<?= $once['id'] ?>')">
