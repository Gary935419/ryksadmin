		...
		<div class="layui-col-md12">
			<div class="layui-card">
				<div class="layui-card-body ">
					<form class="layui-form layui-col-space5" method="get" action="<?= RUN, '/goods/goods_list1_caij' ?>">
									...
									<td class="td-manage">
										<?php if ($once['openflg1']>=1){ ?>
											<button class="layui-btn layui-btn-normal"
													onclick="xadmin.open('裁断信息编辑','<?= RUN . '/goods/goods_edit_new22_caij?id=' ?>'+'<?= $once['id'] ?>')">
												<i class="layui-icon">&#xe642;</i>裁断信息编辑
											</button>
										<?php }else{ ?>
											<button class="layui-btn layui-btn-normal"
													onclick="xadmin.open('裁断信息添加','<?= RUN . '/goods/goods_add_new22_caij?id=' ?>'+'<?= $once['id'] ?>')">
