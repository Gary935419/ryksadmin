									...
									<div class="layui-row">
										<form method="post" enctype="multipart/form-data" class="layui-form" style="margin-top: 15px" action="" name="basic_validate" id="tab">
											<div class="layui-form-item">
												<input type="hidden" id="btype" name="btype" lay-verify="btype" value="<?php echo $btype ?>">
												<input type="hidden" id="id" name="id" lay-verify="id" value="<?php echo $id ?>">
											...
											<div class="layui-form-item" style="margin-left: 100px;font-size: 13px;font-weight: bold;color: red;">
												温馨提示:导入的文件就是系统导出时生成的文件。提供给小程序端在线打开预览。
											</div>
											<div class="layui-form-item">
				...
				$("#tab").validate({
					submitHandler: function (form) {
						$.ajax({
							cache: true,
							type: "POST",
							url: "<?= RUN . '/goods/goods_save_jihua_excel_baojia' ?>",
							data: $('#tab').serialize(),
							async: false,
